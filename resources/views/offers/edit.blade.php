...
@section('CONTENT')
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <h4 class="title">Editar Oferta #{{ $offer->id }}</h4>
            </div>
            <div class="content">

                <form action="{{ route('offers.update',['id'=>$offer->cid]) }}" method="post">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control border-input" placeholder="Código (Loja)" value="{{ old('code', $offer->code) }}" name="code" required autofocus />
                                @if($errors->has('code'))
                        ...
                        <div class="col-md-9">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control border-input" placeholder="Titulo da Oferta" value="{{ old('title', $offer->title) }}" name="title" required />
                                @if($errors->has('title'))
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="url" class="form-control border-input" placeholder="Link da Oferta (Loja)" value="{{ old('url', $offer->url) }}" name="url" required />
                                @if($errors->has('url'))
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="url" class="form-control border-input" placeholder="Link da Imagem" value="{{ old('image',$offer->image) }}" name="image" required />
                                @if($errors->has('image'))
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control border-input" id="preco_total" name="total_price" placeholder="Preço" value="{{ old('total_price', number_format($offer->total_price,2,',','.')) }}">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="number" id="parcela" class="form-control border-input" name="plots" placeholder="Parcelas" value="{{ old('plots', $offer->plots) }}">
                                @if($errors->has('plots'))
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control border-input" id="valor_parcela" name="plots_price" placeholder="Preço Parcela" value="{{ old('plots_price', number_format($offer->plots_price,2,',','.')) }}">
